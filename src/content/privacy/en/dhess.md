---
title: "Dhess – Privacy Policy"
description: "Privacy Policy for the Dhess application."
language: "en-US"
theme_color: "#f4f6f5"
...
Dhess is a chess-like placement puzzle: the player puts every piece on the board so that no two of them attack each other.
...
Hints are paid for with credits. Credits are earned by solving levels, arrive once a day, and can be added by choosing to watch an ad. They cannot be bought and have no monetary value.

## 2. Data stored locally

The app may store the following information locally on the device:

- game progress: solved levels, the level in progress with its moves, and statistics;
- the credit balance and the time of the last daily credits;
- game and display settings, such as sound, piece color, which controls are shown, and auto check;
- whether the tutorial has been shown;
- review-prompt data: the number of launches and solved levels, and when and in which version the last prompt appeared.
...
- the time and technical context of a crash.
