---
title: "The Filler – Política de privacidad"
description: "Política de privacidad de la aplicación The Filler."
language: "es-ES"
theme_color: "#081722"
effective_date: "17 de septiembre de 2026"
last_updated: "23 de septiembre de 2026"
...
The Filler es un juego para móvil en el que los jugadores hacen crecer y sueltan bolas para llenar un tablero, mientras evitan obstáculos en movimiento. Se juega a lo largo de tres capítulos de niveles y retos.

La aplicación no requiere cuenta, registro, nombre, número de teléfono ni dirección de correo electrónico. La aplicación no gestiona su propia cuenta de usuario ni un sistema de gestión interno. La aplicación no solicita acceso a la ubicación, los contactos, la cámara, el micrófono ni a los datos de la galería de fotos. La aplicación no incluye compras dentro de la aplicación ni funciones de suscripción.

## 2. Datos almacenados localmente

La aplicación puede almacenar la siguiente información localmente en el dispositivo:

- progreso: estrellas obtenidas en cada nivel y los retos completados, en cada capítulo;
- ajustes de sonido, vibración e instrucciones de los niveles;
- qué instrucciones de los niveles ya se han mostrado y si se ha visto el tutorial;
- la última posición en cada nivel y la lista de retos.

Esta información no se envía a mi propio servidor. Los datos locales pueden eliminarse borrando la aplicación o limpiando sus datos.

La configuración de idioma del dispositivo se lee al iniciar la aplicación, de modo que el juego se pueda mostrar en ese idioma cuando exista una traducción. La aplicación no almacena esta información ni la envía a ningún sitio.
...
La aplicación utiliza Firebase Crashlytics para detectar, investigar y corregir fallos y otros problemas técnicos.

Crashlytics puede tratar, entre otros:

- informes de fallos y trazas de la pila;
- la versión de la aplicación y su identificador de paquete;
- información del sistema operativo y del dispositivo;
- identificadores de instalación de Crashlytics y Firebase;
- el momento y el contexto técnico del fallo, incluido el nivel que se estaba jugando.

La aplicación no solicita directamente nombre, número de teléfono ni dirección de correo electrónico.

Más información en la [documentación de privacidad y seguridad de Firebase](https://firebase.google.com/support/privacy).

Google y los demás proveedores externos utilizados por la aplicación ofrecen una protección de datos igual o equivalente a la descrita en esta Política de privacidad, en lo aplicable a sus servicios.

## 6. IDFA y «App Tracking Transparency»

En iOS, la aplicación solicita permiso a través del marco «App Tracking Transparency» (ATT) de Apple antes de poder utilizar el identificador de publicidad (IDFA). La solicitud aparece una vez que se configura la publicidad, y la respuesta se puede modificar en cualquier momento en los Ajustes de iOS, en Privacidad y seguridad → Seguimiento.

Si se concede el permiso, la publicidad puede utilizar el identificador para personalizar los anuncios que se muestran. Si se deniega —o si las solicitudes de seguimiento están desactivadas para todas las aplicaciones—, la publicidad sigue apareciendo, pero no está personalizada y no se utiliza el identificador.

Android no cuenta con un aviso equivalente. En este sistema, el identificador publicitario se rige por las opciones de consentimiento descritas anteriormente, y puede restablecerse o eliminarse en los Ajustes de Android, en Privacidad → Anuncios.
