---
title: "The Filler – Politique de confidentialité"
description: "Politique de confidentialité de l’application The Filler."
language: "fr-FR"
theme_color: "#081722"
...
The Filler est un jeu mobile dans lequel les joueurs font grossir et lâchent des balles pour remplir un plateau de jeu tout en évitant des obstacles mobiles. Le jeu se déroule en trois chapitres composés de niveaux et de défis.
...
- progression : étoiles gagnées pour chaque niveau et défis terminés, dans chaque chapitre ;
- paramètres relatifs au son, aux vibrations et aux descriptions de niveaux ;
- quelles descriptions de niveaux ont déjà été affichées, et si le tutoriel a été consulté ;
- la dernière position atteinte dans chaque niveau et la liste des défis.
...
- les rapports de plantage et les traces d’exécution ;
- la version de l’application et son identifiant de package ;
- les informations sur le système d’exploitation et l’appareil ;
- les identifiants d’installation Crashlytics et Firebase ;
- le moment et le contexte technique du plantage, y compris le niveau en cours.

L’application ne demande pas directement de nom, de numéro de téléphone ou d’adresse e-mail.

Plus d’informations dans la [documentation Confidentialité et sécurité de Firebase](https://firebase.google.com/support/privacy).
