...
Rectangle est un jeu mobile dans lequel les joueurs recherchent des carrés ou des rectangles formés de quatre cases de la même couleur.

L’application ne nécessite ni compte, ni inscription, ni nom, ni numéro de téléphone, ni adresse e-mail. Je n’exploite pas de système de comptes ou de backend applicatif propre. L’application ne demande pas l’accès à la localisation, aux contacts, à l’appareil photo, au microphone ou à la photothèque. Elle ne propose ni achats intégrés ni abonnements.

## 3. Données stockées localement

L’application peut stocker localement sur l’appareil :

- les préférences du jeu et de l’affichage ;
- les réglages du son et de la musique ;
- l’état d’affichage de l’aide du jeu ;
- les préférences du rappel d’évaluation.
...
- les identifiants techniques ou publicitaires ;
- les impressions et interactions avec les publicités ;
- la version de l’application et l’environnement technique.

L’utilisation de publicités personnalisées dépend des paramètres de consentement et d’opposition applicables.
...
Dans l’Espace économique européen, au Royaume-Uni et en Suisse, UMP peut afficher les messages de consentement requis. Les utilisateurs des États américains concernés peuvent gérer les options d’opposition disponibles dans les réglages de confidentialité de l’application.
...
Crashlytics peut notamment traiter :

- les rapports de plantage et traces de pile ;
...
- l’heure et le contexte technique du plantage.

L’application ne demande pas directement de nom, de numéro de téléphone ou d’adresse e-mail. Plus d’informations dans la [documentation de confidentialité et de sécurité de Firebase](https://firebase.google.com/support/privacy).
